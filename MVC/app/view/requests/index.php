	...
	<body>
		<?php foreach($this->requests as $request): ?>
			...
			<tr>
				...
				<a href="<?=PROOT?>requests/delete/<?=$request->id?>" class="btn btn-danger btn-xs" onclick="if(!confirm('Are you sure to Delete <?=$request->service;?>')){return false;}"><i class="glyphicon glyphicon-remove"></i> Delete </a></td>
			</tr>
